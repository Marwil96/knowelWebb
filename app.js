...
PC.init = function () {
  ...
  // product catalog space. Feel free to replace them with our own.
   PC.contentfulClient = contentful.createClient({
    accessToken: '4e6fcdb954c4df8aa90cd15a5ff174583dc875b8dcd665a44daa8701e61f5169',
    space: 'u77pt0wt1hza'
  })

  // IDs of some of the Content Types used in the app
  PC.config = {
    journeyContentTypeId: 'journey',
    boardMemberInformationContentTypeId: 'boardMemberInformation',
    landingPageInformationContentTypeId: 'landingPageInformation'
  }
...
function loadPage(href) {
  ...
  var page = PC.pages[pageName] || PC.pages.landingPage
  var loader
  switch(pageName) {
